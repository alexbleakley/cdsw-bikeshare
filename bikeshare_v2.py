...
model_feature_cols = ['season_1','season_2','season_3','season_4'] + feature_cols[1:]
zip(model_feature_cols, model.named_steps['elasticnet'].coef_)
for i in range(0,len(model_feature_cols)):
  cdsw.track_metric(model_feature_cols[i], model.named_steps['elasticnet'].coef_[i])
